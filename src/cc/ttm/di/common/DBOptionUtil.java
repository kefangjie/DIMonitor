...
import cc.ttm.di.exceptions.ServiceLocatorException;
...
public class DBOptionUtil {
	...
	public static final String HIBERNATE_PATH=System.getProperty("user.dir") + "/config/hibernate.properties";
